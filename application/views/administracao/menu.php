<div id="wrapper">
          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>administracao/cursos">Área Administrativa</a>
                <a  style="font-size: 12px;" class="navbar-brand" href="<?php echo base_url(); ?>">Visualizar Site</a>
            </div>
